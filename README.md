...
|---|---|---|
| Content category predicts engagement far more strongly than posting time or platform, with Educational and Customer Story content scoring a 0.20 median engagement rate against 0.08 for Entertainment | Reallocate content production toward Educational and Customer Story formats, and reduce investment in Entertainment content | ✓ Educational and Customer Story content outperform Entertainment by 150% on engagement rate, with low variance, meaning the advantage is consistent rather than driven by occasional viral posts.<br><br>✓ Engagement rate is a leading indicator of organic reach, so lifting underperforming category output toward the 0.20 benchmark raises overall engagement without increasing total posting volume. |
| Video dominates post volume at 52.6% of all posts but underperforms Image and PDF posts on engagement rate (0.14 versus 0.18) | Rebalance the content mix toward Image and PDF formats where current strategy over-indexes on Video | ✓ Image and PDF posts achieve the highest median engagement rate of all post types, while Video, the single most produced format, sits at the bottom alongside Live Stream.<br><br>✓ Shifting even a modest share of Video output toward Image or PDF formats raises average engagement without requiring any additional content production. |
| Posting time and platform choice show only a marginal effect on engagement rate, with platform medians ranging just 0.14 to 0.16 and no meaningful pattern by day or hour | Deprioritise best-time-to-post optimisation and redirect that planning effort into content category and format strategy | ✓ The EDA confirmed engagement rate is remarkably consistent across all 6 platforms, with content type and category mattering far more than where or when a post goes live.<br><br>✓ Removing a commonly held but unsupported assumption from the content calendar process frees planning time for higher-impact decisions. |
| Only 23.6% of all posts qualify as High engagement performers, while 55.5% sit in the Medium tier | Audit the Medium-tier majority for the specific content and format attributes shared with the High-tier 23.6%, and apply those attributes systematically | ✓ PDF posts already achieve a 44% High engagement rate and Image posts 36%, well above the 23.6% portfolio average, showing the High-tier playbook already exists within the current content.<br><br>✓ Moving even a modest share of Medium-tier posts into the High tier lifts the High Performer Rate without increasing total posting volume. |
| 3 of 6 platforms, Instagram, X.com, and YouTube, report no Click or CTR data at all, while the remaining 3 report a flat 2% CTR with no meaningful variation | Treat CTR as a platform coverage gap rather than a reliable cross-platform metric, and prioritise closing the tracking gap on the 3 silent platforms before using CTR in funnel decisions | ✓ Two-thirds of platform coverage is missing from click tracking, which severely limits the scope of any funnel or conversion analysis built on CTR today.<br><br>✓ Closing this gap would unlock a genuinely comparable, six-platform CTR metric for future funnel reporting. |
| Hashtag usage is heavily concentrated, with the top 3 of 18 hashtags used accounting for 61.6% of all posts | Test a wider hashtag rotation to reduce reliance on the 3 dominant tags | ✓ A 61.6% concentration in just 3 hashtags out of 18 available creates exposure if any single tag's reach or algorithmic visibility declines.<br><br>✓ Diversifying hashtag usage protects overall reach against single-point-of-failure risk in the current strategy. |
...
- A dedicated `dim_Hashtag` table, since `Main_Hashtag` currently lives directly on `fact_Posts` rather than as its own dimension, limiting hashtag-level drill-down.
...
The interactive dashboard of this project can be viewed [here](https://bit.ly/4uYAs83).   
