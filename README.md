...
| N - Narrate the Story | - Designed the dashboard in Figma first, then manually rebuilt the visuals natively in Power BI using a custom Glacier Bloom theme. <br><br> - **HOW?** Used the Figma  to scope and build the design, then applied the finished design into the live Power BI report through background images and button-based page navigation. |
